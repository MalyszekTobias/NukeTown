...
def load():
    ...
    images["RusUp"] = rl.load_texture("app/assets/Spritesheets/Russian_Up.png")
    images["RusDown"] = rl.load_texture("app/assets/Spritesheets/Russian_Down.png")
    images["RusLeft"] = rl.load_texture("app/assets/Spritesheets/Russian_Left.png")
    images["RusRight"] = rl.load_texture("app/assets/Spritesheets/Russian_Right.png")
    images["Healthbar"] = rl.load_texture("app/assets/Spritesheets/Healthbar_HD.png")
